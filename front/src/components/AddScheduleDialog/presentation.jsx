...
const AddScheduleDialog = ({
  ...
  return (
    <Dialog open={isDialogOpen} onClose={closeDialog} maxWidth="xs" fullWidth>
      ...
      <DialogContent>
        <Title autoFocus fullWidth placeholder="タイトルと日時を追加" value={title}
          onChange={e => setSchedule({ title: e.target.value })} onBlur={setIsEditStart} error={isTitleInvalid} />
        ...
        <Grid container spacing={1} alignItems="center" justify="space-between">
          ...
          <Grid item xs={10}>
            <TextField style={spacer} fullWidth placeholder="場所を追加" value={location}
        ...
        <Grid container spacing={1} alignItems="center" justify="space-between">
          ...
          <Grid item xs={10}>
            <TextField style={spacer} fullWidth placeholder="説明を追加" value={description}
